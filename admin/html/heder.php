...
<body>
  <div>
<nav class="navbar navbar-expand-lg navbar-light bg-light" style="position:fixed; width:100vw; z-index:1050; top:0; left:0;">
      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu" aria-labelledby="authDropdown">
            ...
            <li><a class="dropdown-item" href="Subscribers.php">Subscriber's</a></li>
          </ul>
        </li>
      </ul>
      <?php if(isset($_SESSION['auth'])): ?>
        <span class="me-3">Welcome, <?= htmlspecialchars($_SESSION['uname']); ?></span>
...
<?php if (isset($_SESSION['message'])) { ?>
  <div style="margin-top:70px;" class="alert alert-warning alert-dismissible fade show" role="alert">
