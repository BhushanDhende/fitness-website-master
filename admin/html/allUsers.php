    ...
    <div class="w-100" style="max-width: 1200px; padding-top: 60px;">
        ...
        <form method="get" class="mb-3 d-flex justify-content-center">
            <div class="input-group" style="max-width: 300px;">
                ...
                <a href="allUsers.php" class="btn btn-secondary">Reset</a>
            </div>
        </form>
        <div class="table-responsive" style="overflow-y: auto;">
            <table class="table table-bordered mb-0">
                ...
                if (isset($_GET['search_user_id']) && $_GET['search_user_id'] !== "") {
                    ...
                    $where = "WHERE id = $search_user_id";
                }
                $result = mysqli_query($conn, "SELECT id, name, username, email, password FROM users $where ORDER BY id DESC");
