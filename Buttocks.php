...
<html lang="en">
  <head>
    ...
    <title>Lean'N'Green : Anatomy and Workout : Buttocks</title>
    <!-- Favicon -->
          ...
          <div class="errror-page-area">
            ...
            <div class="error-content">
              ...
              include('db.php');
                ...
                $query = "SELECT * FROM exercises WHERE muscle_group = 'Buttocks' ORDER BY name";
                $stmt = $pdo->prepare($query);
                $stmt->execute();
                $exercises = $stmt->fetchAll(PDO::FETCH_ASSOC);
                ?>

                <h1>Buttocks Exercises</h1>
                      ...
                      <td>
                        <?php
                          if (isset($_SESSION['id'])): ?>
                            <a href="log_exercise.php?exercise_id=<?= urlencode($exercise['id']) ?>&muscle_group=Buttocks"
