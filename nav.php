  ...
  <div class="header-top">
    <div class="container">
      <form action="search.php" method="GET">
        <div id="search">
          <input type="text" placeholder="Search workouts, plant protein, muscle anatomy, BMI..." name="q" id="m_search"
...
<div aria-hidden="true" role="dialog" tabindex="-1" id="login-form" class="modal leread-modal fade">
  <div class="modal-dialog">
    <div class="modal-content"
      style="border-radius:16px; overflow:hidden; border:none; box-shadow:0 20px 40px rgba(0,0,0,0.2);">
      <!-- Login Section -->
      <div id="login-content">
        <div class="modal-header" style="background:#0f172a; color:#fff; padding:18px 24px; border:none;">
          <button aria-label="Close" data-dismiss="modal" class="close" type="button"
            style="color:#fff; opacity:0.8;"><span aria-hidden="true">&times;</span></button>
          <h4 class="modal-title"
            style="font-family:'Outfit',sans-serif; font-weight:700; display:flex; align-items:center; gap:8px;">
        ...
        <div class="modal-body" style="padding:28px 24px;">
          <form method="post" action="">
            <div class="form-group" style="margin-bottom:18px;">
              ...
              <input type="text" name="login_username" placeholder="Enter your username" class="form-control"
                style="height:46px; border-radius:10px; border:1px solid #cbd5e1;" required>
            </div>
            <div class="form-group" style="margin-bottom:20px;">
              <label style="font-size:13px; font-weight:600; color:#475569; margin-bottom:6px;">Password</label>
              <input type="password" name="login_password" placeholder="Enter your password" class="form-control"
                style="height:46px; border-radius:10px; border:1px solid #cbd5e1;" required>
            </div>
            <div class="loginbox"
              style="display:flex; justify-content:space-between; align-items:center; margin-top:20px;">
              <label style="font-weight:normal; font-size:13px; color:#64748b;"><input type="checkbox"
                  style="margin-right:6px;"> Remember me</label>
              <button class="btn" type="submit" name="login"
                style="background:linear-gradient(135deg, #10b981, #059669); color:#fff; font-weight:600; padding:10px 24px; border-radius:10px; border:none; box-shadow:0 4px 12px rgba(16,185,129,0.3);">
                Sign In
              </button>
            </div>
          </form>
        ...
        <div class="modal-footer footer-box"
          style="background:#f8fafc; border-top:1px solid #e2e8f0; padding:16px 24px; display:flex; justify-content:space-between; font-size:13px;">
          <span style="color:#64748b;">No account? <a id="signup-btn" href="#"
              style="color:#10b981; font-weight:600;">Create Account</a></span>
        ...
        <div class="modal-body" style="padding:28px 24px;">
          <form method="post" action="">
            <div class="form-group" style="margin-bottom:14px;">
              ...
              <input name="signup_name" placeholder="John Doe" class="form-control"
                style="height:44px; border-radius:8px; border:1px solid #cbd5e1;" required>
            </div>
            <div class="form-group" style="margin-bottom:14px;">
              <label style="font-size:13px; font-weight:600; color:#475569; margin-bottom:4px;">Username</label>
              <input name="signup_username" placeholder="johndoe" class="form-control"
                style="height:44px; border-radius:8px; border:1px solid #cbd5e1;" required>
            </div>
            <div class="form-group" style="margin-bottom:14px;">
              <label style="font-size:13px; font-weight:600; color:#475569; margin-bottom:4px;">Email</label>
              <input name="signup_email" placeholder="john@example.com" class="form-control"
                style="height:44px; border-radius:8px; border:1px solid #cbd5e1;" required type="email">
            </div>
            <div class="form-group" style="margin-bottom:18px;">
              <label style="font-size:13px; font-weight:600; color:#475569; margin-bottom:4px;">Password</label>
              <input type="password" name="signup_password" placeholder="Create password" class="form-control"
                style="height:44px; border-radius:8px; border:1px solid #cbd5e1;" required>
            </div>
            <div style="display:flex; justify-content:space-between; align-items:center; margin-top:16px;">
              <span style="font-size:13px; color:#64748b;">Have an account? <a id="login-btn" href="#"
                  style="color:#10b981; font-weight:600;">Sign In</a></span>
              <button class="btn" type="submit" name="signup"
                style="background:linear-gradient(135deg, #10b981, #059669); color:#fff; font-weight:600; padding:10px 24px; border-radius:10px; border:none;">
                Register
              </button>
            </div>
          </form>
        ...
        <ul id="top-menu" class="nav navbar-nav navbar-right main-nav">
          ...
          <li
            ...
            <ul class="dropdown-menu" role="menu">
              <li class="<?php echo ($currentPage == 'Muscles.php') ? 'active' : ''; ?>"><a href="Muscles.php"><i
                    class="fa fa-cube" style="margin-right:8px; color:#10b981;"></i>Muscles</a></li>
              <li class="<?php echo ($currentPage == 'Terminolgies.php') ? 'active' : ''; ?>"><a
                  href="Terminolgies.php"><i class="fa fa-book"
                    style="margin-right:8px; color:#10b981;"></i>Terminologies</a></li>
              <li class="<?php echo ($currentPage == 'Plant-Protein.php') ? 'active' : ''; ?>"><a
                  href="Plant-Protein.php"><i class="fa fa-leaf" style="margin-right:8px; color:#10b981;"></i>Plant
                  Protein</a></li>
            </ul>
          </li>
          <li
            class="dropdown <?php echo ($currentPage == 'cardio.php' || $currentPage == 'Anatomy-and-Exercises.php' || $currentPage == 'Chest.php' || $currentPage == 'Arms.php' || $currentPage == 'Legs.php' || $currentPage == 'Back.php' || $currentPage == 'Shoulder.php' || $currentPage == 'Abdomen.php') ? 'active' : ''; ?>">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              Workout <i class="fa fa-angle-down"></i>
            </a>
            <ul class="dropdown-menu" role="menu">
              <li class="<?php echo ($currentPage == 'cardio.php') ? 'active' : ''; ?>"><a href="cardio.php"><i
                    class="fa fa-heartbeat" style="margin-right:8px; color:#10b981;"></i>Cardio</a></li>
              <li class="<?php echo ($currentPage == 'Anatomy-and-Exercises.php') ? 'active' : ''; ?>"><a
                  href="Anatomy-and-Exercises.php"><i class="fa fa-dumbbell"
                    style="margin-right:8px; color:#10b981;"></i>Anatomy & Exercises</a></li>
          ...
          <li
            ...
            <ul class="dropdown-menu" role="menu">
              <li class="<?php echo ($currentPage == 'Vegan-Diet-Plan.php') ? 'active' : ''; ?>"><a
                  href="Vegan-Diet-Plan.php"><i class="fa fa-apple-alt"
                    style="margin-right:8px; color:#10b981;"></i>Vegan Diet Plan</a></li>
              <li class="<?php echo ($currentPage == 'Workout-Routine.php') ? 'active' : ''; ?>"><a
                  href="Workout-Routine.php"><i class="fa fa-calendar-check"
                    style="margin-right:8px; color:#10b981;"></i>Workout Routine</a></li>
            </ul>
          </li>
          ...
          <li
            class="dropdown <?php echo ($currentPage == 'exercise-done.php' || $currentPage == 'user-setting.php') ? 'active' : ''; ?>">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              Profile <i class="fa fa-angle-down"></i>
            </a>
            <ul class="dropdown-menu" role="menu">
              <li class="<?php echo ($currentPage == 'exercise-done.php') ? 'active' : ''; ?>"><a
                  href="exercise-done.php"><i class="fa fa-check-circle"
                    style="margin-right:8px; color:#10b981;"></i>Exercise Log</a></li>
              <li class="<?php echo ($currentPage == 'user-setting.php') ? 'active' : ''; ?>"><a
                  href="user-setting.php"><i class="fa fa-cog" style="margin-right:8px; color:#10b981;"></i>Account
                  Settings</a></li>
            </ul>
          </li>
        </ul>
