...
<html lang="en">
  <head>
    ...
    <title>Lean'N'Green : Anatomy and Workout : Arms</title>
    <!-- Favicon -->
          ...
          <div class="errror-page-area">
            ...
            <div class="error-content">
              ...
              include('db.php');
                ...
                $query = "SELECT * FROM exercises WHERE muscle_group = 'Arms' ORDER BY name";
                      ...
                      <td>
                        <?php
                          if (isset($_SESSION['id'])): ?>
                            <a href="log_exercise.php?exercise_id=<?= urlencode($exercise['id']) ?>&muscle_group=Arms"
